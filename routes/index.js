...
const routes = [
  ...
  { path: '/api/user', method: 'POST', description: 'Create a user' },
  { path: '/api/user/:id', method: 'GET', description: 'Get a user by ID' },
  { path: '/api/user/:id', method: 'PUT', description: 'Update a user by ID' },
